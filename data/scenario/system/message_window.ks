;メッセージレイヤの定義
		...
		[position width=1240 height=237 top=417 left=20 ]
			...
			[position page=fore margint=45 marginl=10 marginr=20 marginb=10 vertical=false opacity="210" radius="0" color="0x000000" ]
		...
		[position layer="message1" page=fore margint=5 marginl=10 marginr=10 marginb=10 vertical=false opacity="210" radius="0" color="0x000000" ]
